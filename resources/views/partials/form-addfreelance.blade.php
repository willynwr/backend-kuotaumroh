<div x-show="addFreelanceModalOpen" x-cloak class="fixed inset-0 z-50 flex items-center justify-center"
  ...
  <div class="relative z-10 w-full max-w-4xl rounded-lg bg-white shadow-lg max-h-[90vh] overflow-y-auto"
    ...
    <form x-ref="addFreelanceForm" method="POST" action="/admin/freelance" enctype="multipart/form-data" 
      ...
      <input type="hidden" name="provinsi" x-bind:value="newFreelance.provinsi">
      <input type="hidden" name="kab_kota" x-bind:value="newFreelance.kab_kota">

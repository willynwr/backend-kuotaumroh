<table class="w-full">
  ...
  <tbody>
      ...
      <tr class="border-b transition-colors hover:bg-muted/50 whitespace-nowrap">
        ...
        <td class="p-4 align-middle">
          <div class="flex items-center justify-center gap-2">
            ...
            <button @click="openEditAffiliate(user)" title="Edit" class="text-yellow-600 hover:text-yellow-800 transition-colors">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <tr x-show="paginatedUsers.length === 0">
      <td colspan="11" class="p-8 text-center text-muted-foreground">Tidak ada data affiliate</td>
    </tr>
  </tbody>
</table>

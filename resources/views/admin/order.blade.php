...
@section('content')
  <div x-data="orderApp()">
    ...
    <main class="container mx-auto py-10 animate-fade-in px-4">
      ...
      <div class="mb-6">
        <div class="flex items-start gap-4">
          <a href="{{ route('admin.dashboard') }}" class="inline-flex h-10 w-10 items-center justify-center rounded-md border bg-white hover:bg-muted transition-colors" aria-label="Kembali">
    ...
    {{-- All Dialogs Below --}}
    @include('admin.partials.order-dialogs')
  </div>
@endsection

...
<script src="https://maps.googleapis.com/maps/api/js?key={{ config('services.google_maps.api_key') }}&libraries=places&callback=initGoogleMapsDownlines" async defer></script>
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>

<script>
    // Google Maps callback
    function initGoogleMapsDownlines() {
        console.log('Google Maps API loaded for downlines');
        window.googleMapsLoadedDownlines = true;
    }
</script>

      ...
      <div class="w-full max-w-md space-y-8 animate-fade-in">
        ...
        <div class="rounded-lg bg-card text-card-foreground border-0 shadow-lg">
          ...
          <div class="p-6 pt-0 space-y-4">
            ...
            <!-- Register Link -->
            <a href="signup.html" class="inline-flex items-center justify-center rounded-md border border-input bg-background hover:bg-muted w-full h-11 text-sm font-medium transition-colors">
    ...
    function affiliateLoginApp() {
      return {
        ...
        init() {
          ...
          if (isLoggedIn() && getUserRole() === 'affiliate') {

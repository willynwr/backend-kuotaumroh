        ...
        <div class="max-w-md w-full rounded-lg border bg-white shadow-sm">
          <div class="p-6 text-center space-y-4">
            ...
            <div class="pt-4 space-y-2">
              <button @click="window.location.href = '{{ route('affiliate.dashboard') }}'"
              ...
              <button @click="window.location.href = '{{ route('affiliate.orders') }}'"
      ...
      <div x-show="paymentStatus === 'pending'" x-cloak>
        ...
        <div class="mb-6">
          <div class="flex items-start gap-4">
            <a href="{{ isset($linkReferral) ? url('/dash/' . $linkReferral . '/order') : route('affiliate.order') }}" class="inline-flex h-10 w-10 items-center justify-center rounded-md border bg-white hover:bg-muted transition-colors" aria-label="Kembali">
      ...
      return {
        ...
        async init() {
          ...
          if (!savedOrderData) {
            ...
            window.location.href = '{{ isset($linkReferral) ? url('/dash/' . $linkReferral . '/order') : route('affiliate.order') }}';
            return;
          }

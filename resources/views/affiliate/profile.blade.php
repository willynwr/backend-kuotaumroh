            ...
            <div class="mb-8">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-600 mt-2 text-lg">Kelola informasi akun affiliate Anda</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="bg-gradient-to-r from-primary to-green-600 px-8 py-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-white text-opacity-90 mt-1">Affiliate Kuotaumroh.id</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-8 space-y-8">
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="grid gap-5 md:grid-cols-2">
                                ...
                                <div class="space-y-2">
                                    <label class="text-sm font-semibold text-gray-600 uppercase tracking-wide">ID Affiliate</label>
        ...
        return {
            ...
            async fetchProfile() {
                try {
                    ...
                    const response = await fetch(`/api/affiliate/profile/${linkReferral}`);

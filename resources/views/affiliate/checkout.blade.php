                ...
                <div class="lg:col-span-1 space-y-4">
                    <div class="rounded-lg border bg-white shadow-sm">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="space-y-4">
                                <button @click="handleCheckPayment()" class="w-full inline-flex items-center justify-center gap-2 rounded-md bg-primary text-primary-foreground h-11 px-4 py-2 hover:bg-primary/90 font-medium">
                            ...
                            <div class="hidden sm:block overflow-x-auto">
                                <table class="w-full text-sm text-left">
                                    <thead class="text-xs uppercase bg-muted/50">
                                        <tr><th class="px-4 py-3">No</th><th class="px-4 py-3">Nomor HP</th><th class="px-4 py-3">Paket</th><th class="px-4 py-3 text-right">Subtotal</th></tr>
                                    </thead>
                                    <tbody>
                                        <template x-for="(item, index) in orderData.items" :key="index">
                                            <tr class="border-b">
...
function checkoutApp() {
    return {
        ...
        async init() {
            ...
            if (data.paymentId) { this.paymentId = data.paymentId; this.batchId = data.batchId; await this.fetchQrisData(); }

            ...
            <table class="w-full">
              <thead>
                <tr class="border-b">
                  ...
                  <th class="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Teritorial</th>
              ...
              <tbody>
                <template x-for="tx in paginatedTransactions" :key="tx.id">
                  <tr class="border-b transition-colors hover:bg-muted/50">
                    ...
                    <td class="p-4 align-middle" x-text="tx.teritorial || '-'"></td>
                    <td class="p-4 align-middle text-center" x-text="tx.msisdnCount || 0"></td>
                    ...
                    <td class="p-4 align-middle text-right font-medium" x-text="formatRupiah(tx.profit || 0)"></td>
                ...
                <template x-if="sortedTransactions.length === 0">
                  <tr><td colspan="10" class="p-8 text-center text-muted-foreground">Tidak ada transaksi yang ditemukan</td></tr>
                </template>
              </tbody>
            </table>
            ...
            <table class="w-full">
              <thead>
                <tr class="border-b">
                  ...
                  <th class="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Teritori</th>
              ...
              <tbody>
                <template x-for="(item, idx) in paginatedItems" :key="idx">
                  <tr class="border-b transition-colors hover:bg-muted/50">
                    ...
                    <td class="p-4 align-middle" x-text="item.teritorial || '-'"></td>
                    ...
                    <td class="p-4 align-middle text-right font-medium" x-text="formatRupiah(item.profit || 0)"></td>
                    <td class="p-4 align-middle text-center">
                      <div class="flex items-center justify-center gap-2">
                        <a :href="'tel:' + item.msisdn" class="inline-flex items-center justify-center rounded-md border bg-transparent h-8 w-8 hover:bg-muted transition-colors" title="Telepon">
                          <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                        </a>
                        <a :href="'https://wa.me/' + item.msisdn" target="_blank" class="inline-flex items-center justify-center rounded-md border bg-transparent h-8 w-8 hover:bg-green-50 hover:border-green-500 transition-colors" title="WhatsApp">
                ...
                <template x-if="sortedItems.length === 0">
                  <tr><td colspan="9" class="p-8 text-center text-muted-foreground">Tidak ada data yang ditemukan</td></tr>
                </template>
              </tbody>
            </table>
          ...
          <div class="space-y-4">
            <div class="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p class="font-medium"><span x-text="selectedTransaction?.msisdnCount || 0"></span> nomor</p>
              </div>
              <div>
      ...
      return {
        ...
        init() {
          ...
          if (this.transactions.length > 0) {
            ...
            console.log('msisdnCount:', this.transactions[0].msisdnCount);
            console.log('items:', this.transactions[0].items);
          }
          
          this.$nextTick(() => {
            // Only initialize flatpickr if it's loaded
          ...
          return [...this.filteredTransactions].sort((a, b) => {
            ...
            switch (this.sortKey) {
              ...
              case 'createdAt':
                ...
                break;
              case 'msisdnCount':
                comparison = (a.msisdnCount || 0) - (b.msisdnCount || 0);
                break;
              case 'totalAmount':
        ...
        get filteredTransactions() {
          return this.transactions.filter(tx => {
            ...
            const searchable = [tx.batchId, tx.batchName, formatDateTime(tx.createdAt), String(tx.msisdnCount || 0), formatRupiah(tx.totalAmount), String(tx.totalAmount)].join(' ').toLowerCase();
        ...
        get filteredItems() {
          const allItems = this.transactions.flatMap(tx => (tx.items || []).map(item => ({ ...item, batchId: tx.batchId, createdAt: tx.createdAt, teritorial: tx.teritorial })));

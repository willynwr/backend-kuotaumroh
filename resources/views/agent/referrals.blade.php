...
@section('scripts')
  <script>
    function historyProfitApp() {
      const profitDataRaw = {!! json_encode($profitData ?? [
        'current_balance' => 0,
        'monthly_profit' => 0,
        'yearly_profit' => 0,
        'monthly_history' => [],
      ...
      return {
        profitData: profitDataRaw,
        monthlyHistory: profitDataRaw.monthly_history || [],
        yearlyHistory: profitDataRaw.yearly_history || [],
